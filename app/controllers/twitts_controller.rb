class TwittsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @twitt.save
        format.html { redirect_to twitt_url(@twitt), notice: "Twitt was successfully created." }
  ...
  def update
    respond_to do |format|
      if @twitt.update(twitt_params)
        format.html { redirect_to twitt_url(@twitt), notice: "Twitt was successfully updated." }
